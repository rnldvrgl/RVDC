...
$sql = "SELECT
home_service.appliances_type AS appliances_type, 
home_service.job_type AS job_type,
home_service.date_received AS received_date, 
home_service.date_claimed  AS claimed_date, 
home_service.payment_date  AS payment_date, 
home_service.payment_amount AS payment_amount, 
technicians.full_name AS technician_name,
employees.full_name AS employees
FROM home_service 
INNER JOIN technicians ON home_service.technician_id=technicians.technician_id 
INNER JOIN employees ON employees.employee_id=home_service.employee_id
WHERE home_service.customer_id ='$id'";
