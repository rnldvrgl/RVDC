...
$num_rows = mysqli_num_rows($customers);
            ...
            <div class="container-fluid">
               <div class="row mb-2">
                  ...
                  <div class="col-sm-6 d-grid d-md-flex justify-content-md-end">
                     <a type="button" class="btn btn-success" href="add-customer.php">
         ...
         <section class="content">
            <div class="container-fluid">
               <div class="col-lg-6 col-12">
                  <!-- small card -->
                  <div class="small-box bg-info info-box shadow">
                     <div class="inner">
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <div class="project-actions text-right">
                                             <a type="button" class="btn btn-warning btn-sm" href="customer-details.php?id=<?php echo $row['id']; ?>">
                                                <i class="fas fa-info-circle"></i> View Details
                                             </a>
                                             <a type="button" class="btn btn-secondary btn-sm" href="walk-in-service.php?id=<?php echo $row['id']; ?>">
                                                <i class="fas fa-walking"></i>
                                                View Walk-In Service
                                             </a>
                                             <a type="button" class="btn btn-info btn-sm" href="home-service.php?id=<?php echo $row['id']; ?>">
